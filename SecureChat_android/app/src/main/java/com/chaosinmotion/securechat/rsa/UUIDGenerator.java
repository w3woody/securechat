 ...
 *
 * We generate it ourselves rather than relying on the java.util.UUID class, out of a
 * show of paranoid precaution.
 *
 * The format of the UUID for Version 4 is described in the Wikipedia article here:
